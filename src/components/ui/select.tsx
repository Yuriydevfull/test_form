...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-slate-200 bg-white px-3 py-2 text-sm g-offset-white placeholder:text-slate-500 focus:outline-none focus:g-2 focus:g-slate-950 focus:g-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-slate-800 dark:bg-slate-950 dark:g-offset-slate-950 dark:placeholder:text-slate-400 dark:focus:g-slate-300",
      className
    )}
    {...props}
  >
